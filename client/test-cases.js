...
const TEMPLATES = {
  cleanLane: {
    ...
    goalId: 'F',
    houses: [
      { x: 80, y: 16, w: 220, h: 86 },
      { x: 838, y: 16, w: 230, h: 86 },
      { x: 838, y: 704, w: 220, h: 84 }
    ],
    trees: [
      { x: 360, y: 52 },
      { x: 700, y: 52 },
  ...
  cityGrid: {
    ...
    goalId: 'F',
    houses: [
      { x: 60, y: 16, w: 230, h: 86 },
      { x: 930, y: 16, w: 210, h: 86 },
      { x: 930, y: 704, w: 210, h: 84 }
    ],
    trees: [
      { x: 360, y: 54 },
      { x: 760, y: 54 },
  ...
  zigzagSpine: {
    ...
    goalId: 'F',
    houses: [
      { x: 86, y: 18, w: 220, h: 84 },
      { x: 870, y: 18, w: 220, h: 84 },
      { x: 875, y: 704, w: 215, h: 84 }
    ],
    trees: [
      { x: 360, y: 54 },
      { x: 730, y: 54 },
